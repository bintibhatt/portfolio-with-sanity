    ...
    <nav className="flex justify-between bg-gray-800 text-white py-4 px-6 md:flex md:items-center rounded-t-3xl">
      <div className="hidden md:block md:ml-10">
        <ul className="flex space-x-8 items-center">
          <li className={`hover:text-gray-300 ${isActive("")}`}>
            <Link href="/">Home</Link>
          </li>
          <li className={`hover:text-gray-300 ${isActive("about")}`}>
            <Link href="/about">About</Link>
          </li>
          <li className={`hover:text-gray-300 ${isActive("projects")}`}>
            <Link href="/about/projects">Projects</Link>
          </li>
          <li className={`hover:text-gray-300 ${isActive("achievements")}`}>
            <Link href="/about/achievements">Achievements</Link>
          </li>
          <li className={`hover:text-gray-300 ${isActive("experience")}`}>
            <Link href="/about/experience">Learning</Link>
          </li>
          <li className={`hover:text-gray-300 ${isActive("contact")}`}>
